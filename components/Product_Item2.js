...
export default function Product_Item2({title,id,category,price,description,image}){
    const router = useRouter();
    return(
        <div className="flex-1  align-middle">
            <div className= "p-10 rounded-md  border border-gray-200 flex flex-col items-center justify-center bg-white flex-1 pb-12 ">
                ...
                <button onClick={()=>router.push('/checkout')} className="bg-gradient-to-t my-3 w-full active:to-yellow-500  from-yellow-300 to-yellow-400 border border-yellow-400  rounded-md px-4 py-2 text-md text-gray-900
